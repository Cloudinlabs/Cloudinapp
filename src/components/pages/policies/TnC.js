...
const TnC = () => {
  ...
  return (
    <Fragment>
      <div className="breatcome_policies d-flex align-items-center">
              ...
              <div className="feature_style_five mb-30">
                ...
                <div className="feature_style_five_text">
                  <p>
                    ...
                    the terms “we”, “us” and “our” refer to Cloudin. Cloudin
            ...
            <div className="col-lg-12">
              <div className="feature_style_five mb-30">
                ...
                <div className="feature_style_five_text">
                  ...
                  <ul _ngcontent-nlg-c4="">
                    <li _ngcontent-nlg-c4="">For any unlawful purpose;</li>
                    <li _ngcontent-nlg-c4="">
            ...
            <div className="col-lg-12">
              <div className="feature_style_five mb-30">
                ...
                <div className="feature_style_five_text">
                  ...
                  <p>
                    In no case shall Cloudin, our directors, officers,
